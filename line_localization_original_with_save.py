...
#This is exactly the same script as /limap/limap/runners/line_localization.py from limap, but we save all 2d lines, 3d lines and 
# 3d ids to be able to access them later.
...
def line_localization(cfg, imagecols_db, imagecols_query, point_corresp, linemap_db, retrieval, results_path, img_name_dict=None, logger=None):
    ...
    for qid in tqdm(query_ids):
        ...
        #our change of code: save 2d lines, 3d lines and 3d ids to make them accessible later for visualization
